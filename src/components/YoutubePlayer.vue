  ...
  <div>
    ...
    <div class="player-video-info" v-if="item">
      ...
      <div class="player-video-content">
        <div class="player-video-channel">{{item.snippet.channelTitle }}</div>
        <div class="player-video-viewcount"><icon name="eye" /> {{item.statistics.viewCount | thousands}}</div>
      </div>
    </div>
  </div>
</template>
...
.player-video-info { padding: 1.5em 2em; }
